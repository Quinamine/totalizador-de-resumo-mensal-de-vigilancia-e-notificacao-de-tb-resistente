...
O **Totalizador de Resumo Mensal de Vigilância e Notificação de TB Resistente** é um serviço online gratuito que auxilia na elaboração do resumo mensal de vigilância e notificação de TB resistente por meio do cálculo automático dos totais com base nos dados inseridos pelo usuário. Foi criado de acordo com o modelo da respectiva ficha de resumo mensal actualmente vigente no Serviço Nacional de Saúde em Moçambique.
