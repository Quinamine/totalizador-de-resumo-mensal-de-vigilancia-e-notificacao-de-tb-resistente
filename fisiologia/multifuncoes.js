...
function destacarCelulasComConteudoOmisso() {
    ...
    for(const c of celulas) {
        ...
        if(c.clientWidth <= 36 && c.value.length > 3) {
            ...
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if(c.clientWidth <= 132 && c.value.length > 16) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if(c.clientWidth <= 178 && c.value.length > 22) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if(c.clientWidth <= 194 && c.value.length > 24) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        } else if(c.clientWidth <= 353 && c.value.length > 45) {
            c.classList.add("input--bg-color-danger");
            celulasSaturadas++;
        }
    }
